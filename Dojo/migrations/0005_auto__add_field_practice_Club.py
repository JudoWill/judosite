...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Practice.Club'
        db.add_column('Dojo_practice', 'Club', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['Dojo.Club'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Practice.Club'
        db.delete_column('Dojo_practice', 'Club_id')
