...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GiType.weave'
        db.add_column('Order_gitype', 'weave', self.gf('django.db.models.fields.CharField')(default='Single', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GiType.weave'
        db.delete_column('Order_gitype', 'weave')
    ...
    models = {
        ...
        'Order.gitype': {
            ...
            'weave': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        },
        'Order.orderstatus': {
