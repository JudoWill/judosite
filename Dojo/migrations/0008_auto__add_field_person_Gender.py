...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Dojo_person', 'Gender', self.gf('django.db.models.fields.CharField')(default='Male', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.Gender'
        db.delete_column('Dojo_person', 'Gender')
