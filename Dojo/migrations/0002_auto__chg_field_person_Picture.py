...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('Dojo_person', 'Picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Person.Picture'
        db.alter_column('Dojo_person', 'Picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
